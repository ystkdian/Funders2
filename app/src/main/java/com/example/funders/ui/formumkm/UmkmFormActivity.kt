...
import com.example.funders.databinding.ActivityUmkmFormBinding
import com.example.funders.ui.signup.FinishSignupActivity

class UmkmFormActivity : AppCompatActivity() {

    private lateinit var binding: ActivityUmkmFormBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityUmkmFormBinding.inflate(layoutInflater)
